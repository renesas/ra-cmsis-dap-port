...
#define CDC_DATA_LEN (512U)        // Data Length

/* Macro definitions */
#define USB_RECEIVE_REPORT_DESCRIPTOR (35U) // report descriptor Length
#define USB_RECEIVE_HID_DESCRIPTOR (9U)     // Length of hid descriptor
#define PHID_DATA_LEN (64U)                 // data length
#define CD_LENGTH (84U)                     // offset into g_apl_configuration where HID Description resides
